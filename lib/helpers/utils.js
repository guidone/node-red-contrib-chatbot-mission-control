...
function checkValidators(types, name, value) {
  return _(types).some(function(type) {
    var validator = null;
    switch(type) {
      case 'messages':
...
const utils = {
  ...
  isValidMessage: function(msg, node, { silent = false} = {}) {
  ...
  getUserId: function(msg) {
    if (msg.originalMessage != null && msg.originalMessage.userId != null) {
      return msg.originalMessage.userId;
    }
    return null;
  },
